...
export declare const isPendingUpload: (attachment: unknown) => attachment is LocalUploadAttachment;
/** Whether this attachment's upload already resolved to a URL. */
export declare const isFinishedUpload: (attachment: unknown) => attachment is LocalUploadAttachment;
