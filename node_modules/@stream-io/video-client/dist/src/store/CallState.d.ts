...
import { CallClosedCaption, CallIngressResponse, CallResponse, CallSessionResponse, CallSettingsResponse, GetCallRingStateResponse, EgressResponse, MemberResponse, OwnCapability, ThumbnailResponse, UserResponse, VideoEvent } from '../gen/coordinator';
...
export declare class CallState {
     ...
     */
    updateFromRingState: (ringState: GetCallRingStateResponse) => void;
    /**
