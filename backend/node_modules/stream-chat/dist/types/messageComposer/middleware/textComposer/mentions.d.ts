import { BaseSearchSource, type SearchQueryOptions, type SearchSourceOptions } from '../../../search';
...
export declare class MentionsSearchSource extends BaseSearchSource<MentionSuggestion> {
    ...
    config: Pick<MentionsSearchSourceOptions, 'mentionAllAppUsers' | 'suggestionFactoryMappers' | 'textComposerText' | 'trigger'>;
    ...
    getRoleMentionSuggestions: (query: string, queryOptions?: SearchQueryOptions) => Promise<RoleMentionSuggestion[]>;
    ...
    queryUsers: (searchQuery: string, offset?: number, queryOptions?: SearchQueryOptions) => Promise<UserResponse[]>;
    queryMembers: (searchQuery: string, offset?: number, queryOptions?: SearchQueryOptions) => Promise<UserResponse[]>;
    getUserSuggestionsPage: (searchQuery: string, userOffset?: number, queryOptions?: SearchQueryOptions) => Promise<{
        items: UserSuggestion[];
        nextOffset: number | undefined;
    }>;
    buildUserGroupSearchCursor: (items: UserGroupResponse[]) => string | undefined;
    getUserGroupSuggestionsPage: (searchQuery: string, cursor?: string, queryOptions?: SearchQueryOptions) => Promise<{
        items: UserGroupMentionSuggestion[];
        next: string | undefined;
    }>;
    query(searchQuery: string, queryOptions?: SearchQueryOptions): Promise<{
