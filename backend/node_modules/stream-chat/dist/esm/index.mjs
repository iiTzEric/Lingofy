...
var isUploadCancellation = (error) => axios.isCancel(error) || error instanceof Error && error.name === "AbortError";
  ...
  constructor({ client }) {
    ...
    this._req = async (params, config, retry) => {
      if (!this.cancelToken && !params.close) {
        this.cancelToken = axios3.CancelToken.source();
      }
      try {
...
var StreamChat = class _StreamChat {
  constructor(key, secretOrOptions, options) {
    ...
    this.axiosInstance = axios4.create(this.options);
