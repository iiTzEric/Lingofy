...
import type { AudioSettingsRequestDefaultDeviceEnum, CallRecordingStartedEventRecordingTypeEnum, JoinCallRequest, MemberResponse, OwnCapability, VideoReactionResponse, StartRecordingRequest, StartRecordingResponse } from './gen/coordinator';
...
export type StreamReaction = Pick<VideoReactionResponse, 'type' | 'emoji_code' | 'custom'>;
...
type StreamRNVideoSDKCallManagerStartParams = StreamRNVideoSDKCallManagerRingingParams & {
    cid: string;
};
type StreamRNVideoSDKCallManagerStopParams = StreamRNVideoSDKCallManagerRingingParams & {
...
export type StreamRNVideoSDKGlobals = {
    ...
    callManager: {
         ...
         */
        setup({ defaultDevice, isRingingTypeCall, cid, }: StreamRNVideoSDKCallManagerSetupParams): void;
        /**
         * Starts the in call manager.
         */
        start({ isRingingTypeCall, cid, }: StreamRNVideoSDKCallManagerStartParams): void;
        /**
         * Stops the in call manager.
         */
        stop({ isRingingTypeCall, shouldStopCallManager, }: StreamRNVideoSDKCallManagerStopParams): void;
        /**
