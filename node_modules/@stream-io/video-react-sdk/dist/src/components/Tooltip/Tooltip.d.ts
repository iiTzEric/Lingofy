...
export declare const Tooltip: <T extends HTMLElement>({ children, referenceElement, tooltipClassName, tooltipPlacement, visible, }: TooltipProps<T>) => import("react").JSX.Element | null;
