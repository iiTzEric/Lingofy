 ...
 * @internal
 */
export type CallMediaEngineProvider = () => CallMediaEngine | Promise<CallMediaEngine>;
export declare const setCallMediaEngineProvider: (newProvider: CallMediaEngineProvider) => void;
export declare const getCallMediaEngineProvider: () => CallMediaEngineProvider;
