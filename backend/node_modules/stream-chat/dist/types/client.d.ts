...
export declare class StreamChat {
    ...
    get<T>(url: string, params?: AxiosRequestConfig['params'], config?: Omit<AxiosRequestConfig, 'params'>): Promise<T>;
    put<T>(url: string, data?: unknown): Promise<T>;
    post<T>(url: string, data?: unknown, config?: Omit<AxiosRequestConfig, 'params'>): Promise<T>;
     ...
     */
    queryUsers(filterConditions: UserFilters, sort?: UserSort, options?: UserOptions, requestOptions?: RequestOptions): Promise<APIResponse & {
     ...
     */
    searchUserGroups(options: SearchUserGroupsOptions, requestOptions?: RequestOptions): Promise<SearchUserGroupsResponse>;
    /**
     ...
     */
    queryChannelsRequestWithResponse(filterConditions: ChannelFilters, sort?: ChannelSort, options?: ChannelOptions, requestOptions?: RequestOptions): Promise<QueryChannelsAPIResponse>;
    /**
     ...
     */
    search(filterConditions: ChannelFilters, query: string | MessageFilters, options?: SearchOptions, requestOptions?: RequestOptions): Promise<SearchAPIResponse>;
    /**
     ...
     * @returns {Promise<APIResponse>}
     */
    searchRoles(options: SearchRolesOptions, requestOptions?: RequestOptions): Promise<SearchRolesAPIResponse>;
