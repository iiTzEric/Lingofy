import { type CallMediaEngine, Publisher, Subscriber, TrackPublishOptions } from './rtc';
import type { E2EEManager } from './rtc/e2ee/E2EEManager';
import { CallState } from './store';
import { ScopedLogger } from './logger';
import { AcceptCallResponse, BlockUserResponse, CallRingEvent, CallSettingsResponse, CallStateResponseFields, CollectUserFeedbackRequest, CollectUserFeedbackResponse, DeleteCallRequest, DeleteCallResponse, DeleteRecordingResponse, DeleteTranscriptionResponse, EndCallResponse, GetCallReportResponse, GetCallResponse, GetCallRingStateResponse, GetCallSessionParticipantStatsDetailsResponse, GetOrCreateCallRequest, GetOrCreateCallResponse, GoLiveRequest, GoLiveResponse, JoinCallResponse, KickUserRequest, KickUserResponse, ListRecordingsResponse, ListTranscriptionsResponse, MuteUsersResponse, PinRequest, PinResponse, QueryCallMembersRequest, QueryCallMembersResponse, QueryCallParticipantsRequest, QueryCallParticipantsResponse, QueryCallSessionParticipantStatsResponse, QueryCallSessionParticipantStatsTimelineResponse, QueryCallStatsMapResponse, RejectCallResponse, RequestPermissionRequest, RequestPermissionResponse, RingCallRequest, RingCallResponse, SendCallEventResponse, SendVideoReactionRequest, SendVideoReactionResponse, StartClosedCaptionsRequest, StartClosedCaptionsResponse, StartFrameRecordingRequest, StartFrameRecordingResponse, StartHLSBroadcastingResponse, StartRTMPBroadcastsRequest, StartRTMPBroadcastsResponse, StartTranscriptionRequest, StartTranscriptionResponse, StopAllRTMPBroadcastsResponse, StopClosedCaptionsRequest, StopClosedCaptionsResponse, StopFrameRecordingResponse, StopHLSBroadcastingResponse, StopLiveRequest, StopLiveResponse, StopRecordingResponse, StopRTMPBroadcastsResponse, StopTranscriptionResponse, UnblockUserResponse, UnpinRequest, UnpinResponse, UpdateCallMembersRequest, UpdateCallMembersResponse, UpdateCallRequest, UpdateCallResponse, UpdateUserPermissionsRequest, UpdateUserPermissionsRequestGrantPermissionsEnum, UpdateUserPermissionsRequestRevokePermissionsEnum, UpdateUserPermissionsResponse } from './gen/coordinator';
...
import type { ClientEventReporter, JoinSource } from './reporting';
...
export declare class Call {
     ...
     * @internal an internal method and should not be used outside the SDK.
     */
    updateFromCallStateResponse: (response: CallStateResponseFields) => void;
    /**
     ...
     */
    getRingState: (callSessionId?: string) => Promise<GetCallRingStateResponse>;
    /**
     ...
     * @internal
     */
    ensureMediaFactory: () => Promise<CallMediaEngine>;
    /**
     ...
     *         the live session.
     */
    setE2EEManager: (e2ee: E2EEManager) => void;
    /**
     ...
     */
    sendReaction: (reaction: SendVideoReactionRequest) => Promise<SendVideoReactionResponse>;
    /**
     ...
     */
    grantPermissions: (userId: string, permissions: string[] | UpdateUserPermissionsRequestGrantPermissionsEnum[]) => Promise<UpdateUserPermissionsResponse>;
    /**
     ...
     */
    revokePermissions: (userId: string, permissions: string[] | UpdateUserPermissionsRequestRevokePermissionsEnum[]) => Promise<UpdateUserPermissionsResponse>;
    /**
     ...
     * @internal
     */
    applyDeviceConfig: (settings: CallSettingsResponse, opts: {
        publish: boolean;
