...
const BackgroundFiltersProviderImpl = react.lazy(() => Promise.resolve().then(function () { return require('./embedded-BackgroundFilters-DMStbSEg.cjs.js'); }).then((m) => ({
...
react.forwardRef(function ToggleDeviceSettingsMenuButtonRender({ menuShown }, ref) {
    const { t } = videoReactBindings.useI18n();
...
react.forwardRef(function ToggleMenuButtonRender(props, ref) {
    const { t } = videoReactBindings.useI18n();
...
const ToggleMenuButton$1 = react.forwardRef(function ToggleMenuButtonRender(props, ref) {
    const { useMicrophoneState } = videoReactBindings.useCallStateHooks();
