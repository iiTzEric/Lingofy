...
const BackgroundFiltersProvider = (props) => {
    ...
    const fpsRatioEmaRef = useRef(undefined);
...
const useRenderer = (api, tfLite, call, engine) => {
    ...
    const startMediaPipe = useCallback((ms, onError, onStats) => {
        let outputStream;
        let processor;
        const output = new Promise((resolve, reject) => {
            ...
            processor = new VirtualBackground(track, { ...options, basePath, modelPath: modelFilePath }, { onError, onStats });
    ...
    const startTf = useCallback((ms, onError) => {
        let outputStream;
        let renderer;
        const output = new Promise((resolve, reject) => {
            if (!backgroundFilter) {
