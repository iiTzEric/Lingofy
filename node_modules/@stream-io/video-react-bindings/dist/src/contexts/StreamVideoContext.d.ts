 ...
 */
export declare const StreamVideoProvider: ({ children, client, i18nInstance, language, translationsOverrides, }: PropsWithChildren<StreamVideoProps>) => import("react").JSX.Element;
/**
