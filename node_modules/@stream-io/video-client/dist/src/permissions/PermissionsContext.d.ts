import { CallSettingsResponse, OwnCapability, RequestPermissionRequestPermissionsEnum } from '../gen/coordinator';
...
export declare class PermissionsContext {
     ...
     */
    canRequest: (permission: RequestPermissionRequestPermissionsEnum, settings?: CallSettingsResponse | undefined) => boolean;
}
